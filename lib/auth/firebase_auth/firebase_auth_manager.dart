  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : CheckAndSeeFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
      debugPrint(
          'FirebaseAuthException during $authProvider auth: code=${e.code}, message=${e.message}');
      final errorMsg = switch (e.code) {
        ...
        'operation-not-allowed' =>
          'Error: Email/Password sign-in is disabled in Firebase Auth (enable it in Authentication > Sign-in method).',
        'app-not-authorized' =>
          'Error: This app/domain is not authorized for this Firebase project. Add your domain under Authentication > Settings > Authorized domains.',
        'unauthorized-domain' =>
          'Error: Unauthorized domain. Add this host to Firebase Authorized domains.',
        'invalid-api-key' =>
          'Error: Invalid API key for this Firebase project.',
        'invalid-email' => 'Error: Email format is invalid.',
        'weak-password' =>
          'Error: Password is too weak (must meet Firebase password policy).',
        'network-request-failed' =>
          'Error: Network issue while contacting Firebase. Check your connection and retry.',
        'too-many-requests' =>
          'Error: Too many attempts. Try again in a few minutes.',
        _ => 'Error (${e.code}): ${e.message ?? 'Unknown authentication error'}',
      };
      ScaffoldMessenger.of(context).hideCurrentSnackBar();
      ScaffoldMessenger.of(context).showSnackBar(
