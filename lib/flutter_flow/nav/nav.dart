      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: ProductScanningWidget.routeName,
              path: ProductScanningWidget.routePath,
              builder: (context, params) => ProductScanningWidget(),
              requireAuth: true,
            ),
            FFRoute(
              name: ProductAnalysisWidget.routeName,
              path: ProductAnalysisWidget.routePath,
              builder: (context, params) => ProductAnalysisWidget(),
              requireAuth: true,
            ),
            FFRoute(
              name: HealthInsightDashboardWidget.routeName,
              path: HealthInsightDashboardWidget.routePath,
              builder: (context, params) => HealthInsightDashboardWidget(),
              requireAuth: true,
            ),
            FFRoute(
